 ...
 * [ResolvedConflictDecisionContentionContract.PROCESS_SUFFIX_B].
 *
 * A genuinely distinct class from
 * [ResolvedConflictDecisionContentionContentProviderA] -- not the same class
 ...
 * only to give Racer B its own distinct, independently resolvable
 * `ComponentName`.
 */
public class ResolvedConflictDecisionContentionContentProviderB :
