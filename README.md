...
| 4 | [DL-041 conflict engine](https://github.com/dataloom-sdk/dataloom/issues/95) | IN PROGRESS | Custom detector/resolver contracts and orchestration foundations, plus a bounded first slice of durable unresolved-conflict persistence — `DurableUnresolvedConflictLog` (`#256`, 2026-08-11), not yet wired into the orchestrator | Ship deterministic built-in strategies, decision application, durable resolved-decision persistence, wiring the durable unresolved-conflict log into a real detection call site, audit, loop prevention/quarantine, precedence, restart/concurrency proof, and AC-FUNC-002 |
