...
|---|---|---|
| [Offline-first](./offline-first.md) | Eligible local work must be durable before remote availability is required. | Atomic local-intent/outbox provider contract added; runtime and platform execution pending |
