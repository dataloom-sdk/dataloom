...
| [Circuit administration](./circuit-administration.md) | Partial V1 subsystem | Authorized/idempotent open, close, and reset coordination with production Android Room command persistence and atomic execution; Apple and operations assembly remain. |
...
remaining protocol integrations, Apple circuit administration, complete
