...
|---|---|---|
| [V1 requirements and evidence matrix](./V1-REQUIREMENTS-EVIDENCE-MATRIX.md) | Live Audit-01 mapping for gates #93–#102, all six strategies, mandatory platforms, FR/NFR groups, release evidence, and market gates | Primary control record for detecting missing implementation, platform, restart, security, documentation, or immutable-candidate evidence before a gate or percentage changes |
| [DL-039B durable cache refresh admission](./DL-039B-durable-cache-refresh-admission.md) | Cache-first local serving plus queue-before-scheduler durable continuation admission and frozen replay | Accepted bounded runtime checkpoint; process relaunch, platform callbacks, coherence, events, and complete matrices remain under #102/#101 |
