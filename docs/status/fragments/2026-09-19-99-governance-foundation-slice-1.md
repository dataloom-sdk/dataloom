...
tenant isolation, tamper-evident audit and the signature scheme are decided (ADR-0004); RBAC, tenant guard
...
- `docs/adr/README.md` decision index: add `ADR-0004 | Accepted | Enterprise governance foundation` (and reconcile the
